...
- [x] **EXER-05**: User can complete Grammar Conjugation exercises (given base form + context, pick correct conjugated form) for songs with structured conjugation data
...
- [x] **EXER-07**: User can complete Sentence Order exercises (rebuild a scrambled verse by tapping tokens in correct order) for any song
...
- [x] **DATA-03
**: Anime scene content is generated through the same Claude API pipeline as songs, with equivalent quality validation
...
| EXER-05 | Phase 10 | Complete |
| EXER-06 | Phase 10 | Complete |
| EXER-07 | Phase 10 | Complete |
