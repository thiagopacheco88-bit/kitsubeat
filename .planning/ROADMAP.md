...
- [x] 11.6-12-PLAN.md -- GAP CLOSURE: scripts/seed/19c-fetch-vocab-images.ts (Unsplash API fetcher) + fetch-images npm script + UNSPLASH_ACCESS_KEY env doc + remove empty public/vocab-images/ (SPEC-REQ-8, 9)
