...
**剣八 (*Kenpachi*)** = *ken* (剣) + *hachi* (八, eight). 剣 (*ken*) means sword — one of the most reusable words in anime vocabulary. 剣道 (*kendo*) means the way of the sword. 剣士 (*kenshi*) means swordsman. 剣心 (*kenshin*) means sword heart — Rurouni Kenshin's own name. Once you know *ken*, you hear it constantly across samurai and shonen.

The name-to-vocabulary pattern holds across franchises. 野菜 (*yasai*) means vegetables — the Saiyan race is an anagram of this one word. 案山子 (*kakashi*) means scarecrow — the actual dictionary entry, not a metaphor. 鼬 (*itachi*) means weasel. 苺 (*ichigo*) means strawberry — same sound as Ichigo Kurosaki, completely different kanji. 鹿 (*shika*) means deer — Shikamaru starts with the animal. And 剣 (*ken*) means sword — the same character opens kendo, kenshin, and Kenpachi's name.
