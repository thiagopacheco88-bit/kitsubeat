...
The three admiral names are a Japanese vocabulary lesson hiding in plain sight. 赤犬 (*Akainu*) means Red Dog. 赤 means red, 犬 means dog. 青雉 (*Aokiji*) means Blue Pheasant. 青 means blue, 雉 means pheasant. 黄猿 (*Kizaru*) means Yellow Monkey. 黄 means yellow, 猿 means monkey. The color-animal compounds give you six kanji that appear across anime: 青空 (*aozora*, blue sky), 黄金 (*kogane*, gold), 赤い (*akai*, red). And 正義 (*seigi*, justice). Printed on every Marine coat. Means the upright moral principle: 正 (*sei*, correct/upright) + 義 (*gi*, moral principle), the same 義 in 仁義 (*jingi*, honor and duty), the yakuza code the admirals were built to echo.
